...
class Deck:
    ...
    def _deal(self, number):
        ...
        #for n in range(min(number, self.count())):
            #x = self.cards.pop()
        new_deck = self.cards[-(min(number, self.count())):]
        self.cards = self.cards[:-(min(number, self.count()))]
        return new_deck
...
print("\n......Dealing num cards.....\n")
num = input("Enter number of cards to deal: ")
deck.deal_hand(int(num))
